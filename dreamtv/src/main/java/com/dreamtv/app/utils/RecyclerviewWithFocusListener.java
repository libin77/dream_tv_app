...
public class RecyclerviewWithFocusListener extends RecyclerView {
    ...
    public interface OnDispatchKeyEventListener {
        void onDispatchKeyEventListener(int keyCode);
    }

    public void setOnDispatchKeyEventListener(final OnDispatchKeyEventListener onDispatchKeyEventListener) {
    ...
    public RecyclerviewWithFocusListener(Context context) {
        this(context, null);
    }

    public RecyclerviewWithFocusListener(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public RecyclerviewWithFocusListener(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            ...
            if (this.getChildAt(0) == null) {
                Toast.makeText(getContext(), "get child at 0 is NULL", Toast.LENGTH_SHORT).show();
                return super.dispatchKeyEvent(event);
            }
            mOnDispatchKeyEventListener.onDispatchKeyEventListener(event.getKeyCode());
...
//
//            if (null == focusView) {
//                Toast.makeText(getContext(), "FOCUS VIEW IS NULL, SO SELECTING HOME AS DEFAULT", Toast.LENGTH_SHORT).show();
//                focusView = this.getChildAt(0);
//            }
...
//                        Toast.makeText(getContext(), "D-PAD DOWN", Toast.LENGTH_SHORT).show();
//
//
...
//                        Toast.makeText(getContext(), "D-PAD UP", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(getContext(), "D-PAD RIGHT", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(getContext(), "D-PAD LEFT", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(getContext(), "D-PAD ENTER", Toast.LENGTH_SHORT).show();
//                        if (focusView != null) {
...
//                }
//            } else {
//                Toast.makeText(getContext(), "focusview is NULL", Toast.LENGTH_SHORT).show();
//            }
            return super.dispatchKeyEvent(event);
